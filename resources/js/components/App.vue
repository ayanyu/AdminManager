<template>
    ...
    <div class="flex">
        ...
        <nav class="pt-4">
            <h3 class="fill-current text-blue-600 w-12 h-12 px-5">ClientPortal</h3>

            <p class="pt-12 text-gray-500 text-xs uppercase font-bold px-5">create</p>

            <router-link to="/contacts/create" class="flex items-center py-2 hover:text-blue-600 text-sm px-5">
            ...
            <p class="pt-12 text-gray-500 text-xs uppercase font-bold px-5">General</p>

                    <router-link to="/contacts" class="flex items-center py-2 hover:text-blue-600 text-sm px-5">
                    ...
                    <router-link to="/birthdays" class="flex items-center py-2 hover:text-blue-600 text-sm px-5">
                    ...
                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold px-5">Settings</p>

                    <router-link to="/logout" class="flex items-center py-2 hover:text-blue-600 text-sm px-5">
        ...
        <div class=" flex flex-col flex-1 h-screen overflow-y-hidden flex-1">
            ...
            CONTACTS
                 <div class="rounded-full border border-gray-400 text-white bg-blue-400 w-10 h-10 flex justify-center items-center">
                    ...
                    <div class=" flex flex-col overflow-y-hidden flex-1"><router-view class="p-6 overflow-x-hidden"></router-view></div>
